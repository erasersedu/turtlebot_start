...
def main():
    ...
    jointStates.name = ["arm_waist_joint", "arm_shoulder_joint", "arm_elbow_joint", "arm_wrist_joint", "arm_hand_joint", "head_pan_joint", "head_tilt_joint"]
    ...
    rospy.Subscriber('/wrist_controller/state', JointStateDynamixel, callbackArmWrist)
    rospy.Subscriber('/hand_controller/state', JointStateDynamixel, callbackArmHand)
    ...
    while not rospy.is_shutdown():
        ...
        jointStates.position[3] = stateArmWrist
        jointStates.position[4] = stateArmHand
        jointStates.position[5] = stateHeadPan
        jointStates.position[6] = stateHeadTilt
